...
$txt = "<a href='http://localhost/doctor/confirmar/confirmarreserva.php?key=$key'><p><strong>Confirmar la hora para el $fecha a las $hora</strong></p></a>";
$headers = "From: cursor.cl@aplicacionestest.cl\r\n";
