<section class="reserva" id="reserva">
    <div class="container" id="creserva">
        <div class="row">
            <div class="reserva-caption clearfix">
                ...
                <div class="container" id="container-radios">
                    <div class="row">
                        <div class="col-lg-6 col-lg-offset-3 text-center">
                            <form>
                                <label class="radio-inline active"> <input type="radio"
                                                                           name="optradio" value="xdoctor" checked="">Búsqueda por Doctor
                                </label> <label class="radio-inline"> <input type="radio"
                                                                             name="optradio" value="xespecialidad">Búsqueda por Especialidad
                                </label>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-5 col-md-offset-4 reserva-form"
                     id="reserva-form-doctor">
                    <form class="form" id="selectmode">
                        <div class="form-group">
                            <select class="form-control selectpicker" id="cmbsedes">
                                <option value="" disabled selected hidden>Seleccione Centro
                                    Médico...</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <select class="form-control selectpicker" id="cmbdoctor"
                                    data-live-search="true" disabled>
                                <option value="" disabled selected hidden>Seleccione
                                    Especialista...</option>
                            </select>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-5 col-md-offset-4 reserva-form"
                     style="display: none;" id="reserva-form-especialidad">
                    <form class="form" id="selectespecialidad">
                        <div class="form-group">
                            <select class="form-control selectpicker"
                                    id="cmbsedesespecialidad">
                                <option value="" disabled selected hidden>Seleccione Centro
                                    Médico...</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <select class="form-control selectpicker" id="cmbespecialidad"
                                    disabled>
                                <option value="" disabled selected hidden>Seleccione Centro
                                    Especialidad...</option>
                            </select>
        ...
        Además tiene un botón para presentar le calendario de disponibilidades para el doctor.
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="row">
                                <input class="submit-btn" type="submit" value="CALENDARIO"
                                       id="show_calendar"> <input class='submit-btn' type='submit'
                                       value='INICIO'>;
                            </div>
                        </div>
                        <div class="col-md-7">
                            ...
                            <div class="col-md-12 lbl-info" id="doctor-horas-libres">
                                <div class="col-md-12" id="diahora"></div>

                                    <div class="form-group mx-sm-3">
                                        <select class="form-control selectpicker" id="cmbhoras">
                                            <option value="" disabled selected hidden>Seleccione Hora...</option>
                                        </select>
                                    </div>
                                    <input class="submit-btn" type="submit" value="RESERVAR" id="btnreservar">
                            ...
                            <div class="modal fade" id="myModal" role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" id="modal-body-calendar"></div>
        ...
        Se presenta el calendario con las horas disponibles para el doctor seleccionado.
                ...
                <div id="reserva-hora-paciente" style="display: none;"
                     class="col-md-12 reserva-forms">
                    <!-- 
        Se presenta la información del doctor seleccionado. 
        Presenta la lista de horas dispobibles para la primera hora en adelante.
        Además tiene un botón para presentar le calendario de disponibilidades para el doctor.
