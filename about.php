		<section class="about text-center" id="about">
			<div class="container">
				<div class="row">
					<h2>Nosotros</h2>
					<h4>Brindar atención médica personalizada con énfasis en Ortopedia y Traumatología, con calidez, eficienci técnica y honradez, buscando la mejor solución de los problemas médicos y administrativos para el enfermo y su familia.</h4>
